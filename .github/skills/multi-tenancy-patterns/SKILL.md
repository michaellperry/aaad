...
description: Multi-tenancy implementation patterns and tenant isolation strategies for SaaS applications. Use when implementing multi-tenant data isolation, tenant context resolution, or designing tenant-aware entities.
---
