...
public class TenantTests
{
    ...
    {
        // Arrange
        var tenantIdentifier = "active-tenant";
        var name = "Active Tenant";
        var slug = "active-tenant";

        // Act
        var tenant = new Tenant(tenantIdentifier, name, slug, isActive: true);
    ...
    public void DefaultConstructor_InitializesProperties_WithDefaultValues()
    {
        ...
        // Assert
        tenant.TenantIdentifier.Should().Be(string.Empty);
    ...
    {
        // Arrange & Act
        var tenant = new Tenant("test", "Test", "test");
